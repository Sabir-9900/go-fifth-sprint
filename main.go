...
func (w Walking) Calories() float64 {
	...
	return ((CaloriesWeightMultiplier*w.Weight + (math.Pow(speedMsec, 2) / w.Height * CaloriesSpeedHeightMultiplier * w.Weight)) * w.Duration.Hours() * MinInHours)
}
...
type Swimming struct {
	// добавьте необходимые поля в структуру
	Training       // встраивание общей структуры
